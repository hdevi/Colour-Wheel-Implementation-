//////////////////////////////////////////////////////////////
// peripherals.h - Header file for peripherals.c
//
...
// Variables definitions for Peripherals
// Function Declarations used in Peripherals.c file 
////////////////////////////////////////////////////////////////
...
//for reducing flickering display
 ...
 volatile u32            blue_low_count;
  ...
  volatile u32			pwm_red_H;				// GPIO1 ch0 input port
  volatile u32			pwm_green_H;			// GPIO2 ch0 input port
  volatile u32			pwm_blue_H;				// GPIO3 ch0 input port
  volatile u32			pwm_red_L;				// GPIO1 ch1 input port
  volatile u32			pwm_green_L;			// GPIO2 ch1 input port
  volatile u32			pwm_blue_L;				// GPIO3 ch1 input port
  ...
  int compare_hsv( hsv_t prev,hsv_t next);
